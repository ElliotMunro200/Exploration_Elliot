...
def get_args():
    ...
    parser.add_argument('--disabled', type=int, default=0,
                        help='1: rotation option disabled (default: 0)')
    parser.add_argument('--rot_per_k', type=int, default=1,
                        help='1: perform a rotation after k steps')
    parser.add_argument('--rot_prob', type=float, default=0.3,
                        help='1: perform a rotation by a probability')
    ...
    parser.add_argument('--local_explore_width', type=int, default=64)

    # Logging, loading models, visualization
    parser.add_argument('-w', '--wandb', action='store_true', default=False,
                        help='enables WandB experiment tracking and logging')
    parser.add_argument('-g', '--git_hash', type=str, default=None,
                        help="the git hash for the code associated with the wandb experiment.")
    ...
    parser.add_argument('--map_size_cm', type=int, default=2560)
