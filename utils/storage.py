...
class RolloutStorage(object):
    ...
    def after_update(self): #obs, rec_states, rgb, masks, extras [0] all adopt last of previous episode. should get overwritten if change episode? It does.
...
class GlobalRolloutStorage(RolloutStorage):
    ...
    def insert(self, obs, rgb, rec_states, actions, action_log_probs, value_preds, option, terminations, rewards, masks, extras):
